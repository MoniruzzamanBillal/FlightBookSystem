...
const Login = () => {
  ...
  return (
    <div className="loginContainer ">
      <div className="loginWrapper  h-screen bg-[url('https://i.ibb.co/9Zm7KsR/pexels-pixabay-62623.jpg')] bgImage flex justify-center items-center  ">
        <div className="loginCard     py-9 px-4 w-[92%] xsm:w-[82%] sm:w-[72%] md:w-[64%] xmd:w-[55%] lg:w-[46%] rounded border border-gray-200 backdrop-blur-xl shadow-2xl   ">
          <h1 className="mb-5 text-xl font-bold text-center text-gray-50 headingFont sm:text-2xl xsm:font-semibold sm:font-medium sm:mb-6 md:mb-8 lg:mb-10">
